...
| Version | Supported |
| --- | --- |
| `0.10.1` | Current source release; evidence/documentation patch on `0.10.0` that commits the VS Code MCP client evidence and synchronizes current-state records — no backend behavior change |
