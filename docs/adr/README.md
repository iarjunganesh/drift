...
| [005](005-postgres-pgvector-live-store.md) | PostgreSQL + pgvector for the live store | Accepted; Railway schema and hosted `v0.6.0` empty briefing verified; reviewed capture and hosted retrieval smoke tests pending |
| [006](006-ci-quality-gates.md) | CI quality gates and coverage ratchet | Accepted |
| [007](007-vercel-railway-deployment.md) | Vercel frontend + Railway API and database | Accepted; hosted `v0.6.0` health/empty briefing/docs/banner/CORS verified; reviewed search/chat smoke tests pending |
